...
const ExpressAudit = () => {
  ...
  return (
    <div className="min-h-screen">
        ...
        <section className="relative pt-32 pb-24 bg-gradient-to-b from-white via-blue-50 to-white overflow-hidden">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              {/* Бесплатно бейдж */}
              <div className="inline-flex items-center px-5 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full text-sm font-semibold tracking-wide shadow-md mb-6">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-6">
                Быстрый <span className="text-blue-600">аудит рисков</span>{" "}
                команды
              </h1>
              ...
              <div className="bg-white shadow-xl rounded-xl p-6 md:p-8 max-w-3xl mx-auto mb-6 border border-blue-100">
              ...
              <div className="mt-8">
                <button
                  onClick={() => setStep(2)}
                  className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg px-10 py-4 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300"
                >
          ...
          <div className="absolute top-[-60px] left-[-80px] w-96 h-96 bg-blue-200 opacity-20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-[-40px] right-[-60px] w-80 h-80 bg-indigo-200 opacity-20 rounded-full blur-2xl"></div>
        </section>
      )}
      {step === 2 && (
          ...
          <div className="w-full max-w-xl">
            ...
            <div className="space-y-4">
              <input
                ...
                className={`w-full border p-3 rounded-lg ${userInfoErrors.occupation ? 'border-red-500' : ''}`}
              />
              ...
              <input
                ...
                className={`w-full border p-3 rounded-lg ${userInfoErrors.position ? 'border-red-500' : ''}`}
              />
              ...
              <input
                ...
                className={`w-full border p-3 rounded-lg ${userInfoErrors.age ? 'border-red-500' : ''}`}
              />
              ...
              <button
                ...
                className="bg-blue-600 text-white w-full py-3 rounded-xl mt-4 hover:scale-105 transition"
              >
                Перейти к вопросам
              </button>
            </div>
          ...
          <div className="max-w-2xl w-full">
            ...
            <div className="space-y-3 mb-6">
              {questions[currentQuestion].options.map((option, idx) => (
                <label
                  key={idx}
                  className={`block border px-4 py-3 rounded-lg cursor-pointer ${
      ...
      {step === 4 && (
        <section className="min-h-screen pt-24 px-4 flex items-center justify-center bg-gradient-to-b from-white via-blue-50 to-white">
          <div className="w-full max-w-lg bg-white shadow-2xl rounded-2xl p-8 md:p-10 border border-blue-100 text-center">
            <div className="mb-6">
              <div className="w-14 h-14 mx-auto mb-4 bg-green-100 text-green-600 rounded-full flex items-center justify-center text-2xl font-bold">
                ✔
              </div>
            ...
            <input
              ...
              className="w-full border border-gray-300 p-4 rounded-xl mb-4 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />


            <button
              className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-xl  font-semibold hover:scale-[1.03] transition-transform duration-300 disabled:opacity-60"
      ...
      <div ref={pdfRef} style={{ display: 'none' }}>
        ...
        <div className="prose prose-blue max-w-none text-gray-900" dangerouslySetInnerHTML={{ __html: String(marked.parse(recommendation || "")) }} />
            ...
            <div className="mt-6 text-sm text-gray-500">
              Это{" "}
              <span className="font-medium text-gray-700">предварительная</span>{" "}
            ...
            >
              <p>Перейти на страницу контакт →</p>
            </Link>
          </div>
        </section>
      )}
